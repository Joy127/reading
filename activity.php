    ...
    <div class="container" id="content">
        ...
        <div class="row text-white">
            <div class="col-12 my-3 text-white">
                <h1 class="text-center text-white">藝文活動</h1>                
            </div>
        </div>
        ...
        <?php   
            ...
            curl_setopt($curl, CURLOPT_URL,
             "https://cloud.culture.tw/frontsite/trans/SearchShowAction.do?method=doFindTypeJ&category=200");
            $data = curl_exec($curl);            
            curl_close($curl);            
        ...
        <div class="row ">
            <div class="col-12 my-3 text-white">
                <table class="table text-white" id="book">
                    <thead>
                    <tr>                       
                        <th scope="col-12">活動名稱</th>
                        <th scope="col-12">活動地點</th>                        
                        <th scope="col-12">開始時間</th>
                        <th scope="col-12">結束時間</th>                       
                        <th scope="col-12">活動價格</th> 
                        <th scope="col-12">活動介紹</th>                        
                    </tr>
                    </thead>
                    ...
                    <tbody>                 
                        ...
                        <?php   
                            ...
                            for ($i=0; $i<count($json); $i++) { 
                                $num=count($json[$i]["showInfo"]); 
                                for ($j=0; $j<$num ; $j++) { 
                        ?>            
                            <tr>                         
                                <td><?=$json[$i]["title"];?></td> 
                                <td><?=$json[$i]["showInfo"][$j]["location"];?></td> 
                                <td><?=$json[$i]["showInfo"][$j]["time"];?></td>                                        
                                <td><?=$json[$i]["showInfo"][$j]["endTime"];?></td>                                
                                <td><?=$json[$i]["showInfo"][$j]["price"];?></td>                                
                                <td><?=$json[$i]["descriptionFilterHtml"];?></td> 
                            </tr>
                        <?php  
                                }
                            }

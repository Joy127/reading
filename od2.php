    ...
    <div class="container" id="content">
        ...
        <div class="row text-white">
            <div class="col-12 my-3 text-white">
                <h1 class="text-center text-white">主題動畫</h1>                
            </div>
        </div>
        ...
        <?php   
            ...
            curl_setopt($curl, CURLOPT_URL, "https://children.moc.gov.tw/opendata/2");
            $data = curl_exec($curl);            
            curl_close($curl);
            // 將JSON文字轉為可使用的陣列
            // true 轉陣列，false 轉物件
            ...
            <div class="col-12 my-3 text-white">
                <table class="table text-white" id="book">
                    ...
                    <tr>
                        ...
                        <th scope="col-12">intro</th>               
                        <th scope="col-12">url</th>                   
                    </tr>
                    </thead>
                    ...
                    <tbody>                 
                        ...
                        ?>            
                                    <tr>
                                        <th scope="row"><?=($i+1);?></th>
                                        <td scope="category"><?=$json[$i]["category"]?></td>
                                        <td scope="name"><?=$json[$i]["name"]?></td>
                                        <td scope="intro"><?=$json[$i]["intro"]?></td>
                                        <td scope="url" ><a href="<?=$json[$i]["url"]?>">詳細資料</a></td>                              
                                    </tr>
                        <?php                                               
                            }
                        ?>
